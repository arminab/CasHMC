...
namespace CasHMC
{
    ...
    CasHMCWrapper::~CasHMCWrapper()
    {
        ...
        /////////////////////////////////////////
        //////////////////////////////////////////
        transactionLatencyOut.flush();      transactionLatencyOut.close();
        linkLatencyOut.flush();             linkLatencyOut.close();
        vaultLatencyOut.flush();            vaultLatencyOut.close();
    ...
    //
    string extractTraceName(const char *str, char c = ' ')
    {
    ...
    void CasHMCWrapper::PrintEpochStatistic()
    {
        ...
        //////////////////////////////////////////////////////////////////////////////
        /////////////////////////writing latency results /////////////////////////////
        cout << traceFileName << endl;
        string realTraceName = extractTraceName(traceFileName.c_str(), '/');
        string resNameTransactionLatency = logName + realTraceName + "_transaction_latency.log";
        transactionLatencyOut.open(resNameTransactionLatency.c_str());
        
        string resNameLinkLatency = logName + realTraceName + "_llink_latency.log";
        linkLatencyOut.open(resNameLinkLatency.c_str());
        ...
        for(int i=0; i<tranCount; i++) {
            ...
            transactionLatencyOut << tranFullLat[i] << endl;
            ...
            linkLatencyOut << linkFullLat[i] << endl;
        ...
        for(int i=0; i<errorCount; i++) {
            ...
            //errorRetryLatencyOut << errorRetryLat[i] << endl;
        }
